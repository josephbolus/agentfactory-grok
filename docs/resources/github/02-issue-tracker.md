...
- workflow and security files defining support or vulnerability routes.
...
Add area labels only when someone will use them. Do not keep redundant pairs
such as `bug` and `type:bug`.

...
import (
	...
	"github.com/josephbolus/agentfactory-grok/internal/buildinfo"
)
...
func (c command) run(arguments []string) error {
	...
	case "update":
		return &usageError{message: "factory update was removed; continue via Project status and labels"}
	case "server", "worker":
		if *jsonOutput {

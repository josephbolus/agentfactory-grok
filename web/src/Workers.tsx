    ...
    <div className="page">
      ...
      {registered.length === 0 ? (
        <EmptyState
          ...
          description="Start an Agent Factory Worker and its registration will appear here automatically."
        />
      ) : (
        <>
        ...
        <>
          <section className="panel execution-settings-card">
            ...
            <div className="execution-owner-note">
              ...
              <p>
				Agent Factory reads <code>runtimes</code> and <code>max_concurrent</code> from the Worker TOML at startup.
          ...
          <section className="panel">
            ...
            <p className="settings-copy">
			  ...
			  Agent Factory reports execution capability but does not edit provider-owned settings.
            </p>
          </section>
        </>,
      )}

...
- Embedded version and source commit reporting in all Agent Factory binaries.
...
- Agent Factory has not published a stable release yet. The first tagged release will
  define the initial supported upgrade boundary.

[Unreleased]: approved internal source control

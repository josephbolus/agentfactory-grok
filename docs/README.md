...
- [Agent-directed software factory](software-factory/design.md): earlier
  work-item queue and agent-update proposal; superseded by the label-driven
  kernel in `ARCHITECTURE.md`.
- [Cloud Run agent backend](cloud-run-agents/design.md): proposed elastic
  Cloud Run execution. Removed from current behavior.
